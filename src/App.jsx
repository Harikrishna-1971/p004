...
import { APIURL, callApi } from './lib';  // ./ is current folder
import './App.css';
...
class App extends Component {
  ...
  render() {
    //declare the state 
    //if state is declare we must be instialised the constructor
      ...
      <div className='app'>
        ...
        {showpopup && <div className='overlay'>
          <div className='popup'>
            ...
            <p>
              <span>Company</span>
              <span>{userdata.company.name}, {userdata.company.catchPhrase} - {userdata.company.bs}</span>
            </p>
            </div> 
          </div>}
      </div>
